...
![阶跃三阶段流水线设计](/AFD/image8.png)

![字节四阶段流水线设计](/AFD/image9.png)

与之相比，DeepSeek 采取的大 EP 不分离方案中，实际上只需要两个 micro batch 就能实现比较好的掩盖。

![大EP两阶段重叠对比](/AFD/image10.png)

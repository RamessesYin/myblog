...
![阶跃三阶段流水线设计](/assets/AFD/image8.png)

![字节四阶段流水线设计](/assets/AFD/image9.png)

与之相比，DeepSeek 采取的大 EP 不分离方案中，实际上只需要两个 micro batch 就能实现比较好的掩盖。

![大EP两阶段重叠对比](/assets/AFD/image10.png)
...
![稀疏度约束与通信瓶颈示意](/assets/AFD/image11.png)
...
![字节异构部署成本对比](/assets/AFD/image12.png)
...
![更小规模达成同等效果对比](/assets/AFD/image13.png)
